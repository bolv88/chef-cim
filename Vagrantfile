...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "bolv8899-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/okbuy"
  #   chef.validation_client_name = "okbuy-validator"
  #   chef.validation_key_path = ".chef/okbuy-validator.pem"
  # end
end
